...
export function downloadPurchasedTemplate() {
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.aoa_to_sheet([
      ...
      ["Potencia_Termica_kW_Nuevo", "Recomendado", "Potencia termica del vehiculo en kW. La app calculara automaticamente la potencia equivalente en CV para compararla con IDAE."],
...
export function downloadSoldTemplate() {
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.aoa_to_sheet([
      ...
      ["Precio (SIN IVA)", "Recomendado", "No bloquea validacion ni matching."],
      ["Emisiones_WLTP_gCO2_km", "Recomendado", "Numero en g CO2/km. Ejemplo: 118."],
      ["Potencia_Termica_kW_Vendido", "Recomendado", "Potencia termica del vehiculo en kW. La app calculara automaticamente la potencia equivalente en CV para compararla con IDAE."],
